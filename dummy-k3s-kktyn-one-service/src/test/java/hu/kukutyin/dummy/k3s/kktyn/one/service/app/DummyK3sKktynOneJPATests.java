package hu.kukutyin.dummy.k3s.kktyn.one.service.app;

import hu.kukutyin.dummy.k3s.kktyn.one.service.app.entity.ConstantsEntity;
...
import static hu.kukutyin.dummy.k3s.kktyn.one.service.app.valueset.ConstantsTest.*;

@DataJpaTest
@ActiveProfiles("jpa")
class DummyK3sKktynOneJPATests {
